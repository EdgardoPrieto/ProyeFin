...
public class JFrameSalida extends javax.swing.JFrame {
    ...
    public PertenenciasSalidaController controladorPertenencias;
    public salidaPersonalController controladorIngresoYsalida;
...
//PERTENENCIAS
        editing = false;
        Object[][] content = null;
        this.controladorPertenencias = new PertenenciasSalidaController();
        content = controladorPertenencias.loadDataforTableModel();
        tableModel = new DefaultTableModel(content, header);

//SALIDAS
        this.controladorIngresoYsalida = new salidaPersonalController();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Digite sus pertenencias de Salida");
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(btnIngresarPertenencia, javax.swing.GroupLayout.DEFAULT_SIZE, 159, Short.MAX_VALUE)
...
//Insertamos los datos en la tabla y manejamos la respuesta como antes
        int resp = controladorPertenencias.insert(new PertenenciasSalida(serial, tipo_pertenencias, id_persona));
        int respo = controladorIngresoYsalida.insert(new salidaPersonal(fechaActual, horaActual, id_persona));
        if (resp == 0) {
            ...
            tableModel = new DefaultTableModel(content, header);
            JOptionPane.showMessageDialog(null, "Pertenencia de salida registrada.", "Guardar pertenencias", JOptionPane.INFORMATION_MESSAGE);
