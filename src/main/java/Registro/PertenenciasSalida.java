...
public class PertenenciasSalida {
    int id_pertenencias;
    String serial;
    ...
    public PertenenciasSalida(int id_pertenencias) {
        this.id_pertenencias = id_pertenencias;
    }

    public PertenenciasSalida(String serial, String tipo_pertenencias, int id_persona) {
        this.serial = serial;
        this.tipo_pertenencias = tipo_pertenencias;
        this.id_persona = id_persona;
    }

    public PertenenciasSalida(int id_pertenencias, String serial, String tipo_pertenencias, int id_persona) {
        this.id_pertenencias = id_pertenencias;
        this.serial = serial;
        this.tipo_pertenencias = tipo_pertenencias;
        this.id_persona = id_persona;
