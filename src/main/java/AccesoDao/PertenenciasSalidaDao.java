...
public class PertenenciasSalidaDao {
//     private static final String SQL_ALL = "SELECT id_pertenencias, serial, tipo_pertenencias "
//            + "FROM pertenenciasSalida";
    
    private static final String SQL_ALL = "SELECT * FROM pertenenciasSalida";
    
    private static final String SQL_INSERT = "INSERT INTO pertenenciasSalida (id_pertenencias,"
            + "serial, tipo_pertenencias, id_persona) VALUES (?,?,?,?)";
    
    private static final String SQL_EDIT = "UPDATE pertenenciasSalida SET serial=?,"
            + "tipo_pertenencias=? where id_pertenencias=?";
   
    private static final String SQL_DELETE = "DELETE FROM pertenenciasSalida WHERE id_pertenencias=?";
    
    private static final String SQL_PERTENENCIAS_BY_ID = "SELECT * FROM pertenenciasSalida WHERE id_pertenencias=?";

    
    public ArrayList<PertenenciasSalida> getAll() {
        Connection conn = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        ArrayList <PertenenciasSalida> pertenencia = new ArrayList<>();
        try {
            ...
            while (rs.next()) {
                ...
                pertenencia.add(new PertenenciasSalida(id_pertenencias, serial, tipo_pertenencias, id_persona));
            }
    ...
    public Object[][] getAllV(ArrayList<PertenenciasSalida> pertenencia) {
    ...
    public int delete(int id) {
        Connection conn = null;
        PreparedStatement ps = null;
        PertenenciasSalida PertenenciasByID = null;
        int reg = 0;
        try {
            conn = Conexion.getConnection();
